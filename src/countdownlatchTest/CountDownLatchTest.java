...
public class CountDownLatchTest {
	...
	public static void main(String[] args) {        
		...
		Worker w1 = new Worker("Jerry", getRandomWorkDuration(MIN_WORK_DURATION, MAX_WORK_DURATION));  
		Worker w2 = new Worker("Test2", getRandomWorkDuration(MIN_WORK_DURATION, MAX_WORK_DURATION));  
